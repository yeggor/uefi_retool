...
├──────────────────────────────────────────────────────────────────┼─────────────────────────────┼─────────┼────────────────┼────────────────┤
│ [6378fef3-0xc89f-0x492f-0xbd-0xb1-0xbf-0xb4-0x43-0x19-0xcf-0xda] │ ProprietaryProtocol         │ 0x678L  │ HandleProtocol │ unknown        │
│ [4c8a2451-0xc207-0x405b-0x96-0x94-0x99-0xea-0x13-0x25-0x13-0x41] │ gEfiDebugMaskProtocolGuid   │ 0x658L  │ HandleProtocol │ edk2_guids     │
│ [5b1b31a1-0x9562-0x11d2-0x8e-0x3f-0x0-0xa0-0xc9-0x69-0x72-0x3b]  │ gEfiLoadedImageProtocolGuid │ 0x628L  │ HandleProtocol │ edk2_guids     │
│ [cd2333d7-0x6a0a-0x4c76-0x83-0x50-0x24-0xa-0xda-0x36-0xa2-0xc7]  │ ProprietaryProtocol         │ 0x6f0L  │ LocateProtocol │ unknown        │
│ [ae80d021-0x618e-0x11d4-0xbc-0xd7-0x0-0x80-0xc7-0x3c-0x88-0x81]  │ gEfiDataHubProtocolGuid     │ 0x6c0L  │ LocateProtocol │ edk2_guids     │
│ [e49d33ed-0x513d-0x4634-0xb6-0x98-0x6f-0x55-0xaa-0x75-0x1c-0x1b] │ gEfiSmbusHcProtocolGuid     │ 0x6b0L  │ LocateProtocol │ edk2_guids     │
│ [ef9fc172-0xa1b2-0x4693-0xb3-0x27-0x6d-0x32-0xfc-0x41-0x60-0x42] │ gEfiHiiDatabaseProtocolGuid │ 0x648L  │ LocateProtocol │ edk2_guids     │
│ [fd96974-0x23aa-0x4cdc-0xb9-0xcb-0x98-0xd1-0x77-0x50-0x32-0x2a]  │ gEfiHiiStringProtocolGuid   │ 0x638L  │ LocateProtocol │ edk2_guids     │
└──────────────────────────────────────────────────────────────────┴─────────────────────────────┴─────────┴────────────────┴────────────────┘
```
...
```
```
>python analyser.py ..\\modules\DxeMain.efi

Boot services:
         [0x15fef] EFI_BOOT_SERVICES->LocateHandleBuffer
         [0x1c30f] EFI_BOOT_SERVICES->OpenProtocol
         [0x1bec7] EFI_BOOT_SERVICES->OpenProtocol
         [0x1603c] EFI_BOOT_SERVICES->OpenProtocol
         [0x1c9af] EFI_BOOT_SERVICES->InstallProtocolInterface
         [0x1c2dd] EFI_BOOT_SERVICES->HandleProtocol
         [0x1c33a] EFI_BOOT_SERVICES->HandleProtocol
         [0x1bf98] EFI_BOOT_SERVICES->HandleProtocol
         [0x1c9fd] EFI_BOOT_SERVICES->HandleProtocol
         [0x1be95] EFI_BOOT_SERVICES->HandleProtocol
         [0x1bef2] EFI_BOOT_SERVICES->HandleProtocol
         [0x12f2f] EFI_BOOT_SERVICES->LocateProtocol
         [0x1c7b0] EFI_BOOT_SERVICES->LocateProtocol
         [0x1c744] EFI_BOOT_SERVICES->LocateProtocol
...
Protocols:
         ...
         [guid] ['0x18a031abL', '0xb443', '0x4d1a', '0xa5', '0xc0', '0xc', '0x9', '0x26', '0x1e', '0x9f', '0x71']
         ********************************************************************************************************
         [address] 0x11410
         ...
         ********************************************************************************************************
         ...
         [guid] ['0x83485340L', '0x30ec', '0x8b48', '0x44', '0x24', '0x60', '0x4d', '0x8b', '0xd1', '0x4d', '0x8b']
         **********************************************************************************************************
         [address] 0x11440
         [service] HandleProtocol
         [protocol_name] gEfiLoadedImageProtocolGuid
         [protocol_place] edk2_guids
         [guid] ['0x5b1b31a1L', '0x9562', '0x11d2', '0x8e', '0x3f', '0x0', '0xa0', '0xc9', '0x69', '0x72', '0x3b']
         *********************************************************************************************************
         [address] 0x11400
         [service] HandleProtocol
         [protocol_name] gEfiDevicePathProtocolGuid
         [protocol_place] edk2_guids
         [guid] ['0x9576e91L', '0x6d3f', '0x11d2', '0x8e', '0x39', '0x0', '0xa0', '0xc9', '0x69', '0x72', '0x3b']
         ********************************************************************************************************
         [address] 0x11520
         [service] LocateProtocol
         [protocol_name] gEfiCpuArchProtocolGuid
         [protocol_place] edk2_guids
         [guid] ['0x26baccb1L', '0x6f42', '0x11d4', '0xbc', '0xe7', '0x0', '0x80', '0xc7', '0x3c', '0x88', '0x81']
         *********************************************************************************************************
         [address] 0x11650
         [service] LocateProtocol
         [protocol_name] EFI_PERFORMANCE_PROTOCOL_GUID
         [protocol_place] edk_guids
         [guid] ['0xffecffffL', '0x923c', '0x14d2', '0x9e', '0x3f', '0x22', '0xa0', '0xc9', '0x69', '0x56', '0x3b']
         **********************************************************************************************************
...
Total:
         [number of proprietary protocols] 1
         [full number of protocols] 7
```
 ...
 * Run `pip install -r requirements.txt`
 * Run `python analyse_fw_ida.py -h`
