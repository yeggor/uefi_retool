...
# the directory with all firmware content
dir_name = "all"
# the directory with UEFI images
pe_dir = "modules"
...
if __name__=="__main__":
	if len(sys.argv) != 2:
		print("[*] Usage: $python {0} <FIRMWARE_FILE_NAME>".format(sys.argv[0]))
		exit()
	get_efi_images(sys.argv[1])