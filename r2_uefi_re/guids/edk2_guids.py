...
edk2_guids = {
	# Guids from C' :\UDK2018\AppPkg\AppPkg.dec file 
	'gAppPkgTokenSpaceGuid' : [ 0xe7e1efa6, 0x7607, 0x4a78, 0xa7, 0xdd, 0x43, 0xe4, 0xbd, 0x72, 0xc0, 0x99 ],
	# Guids from C' :\UDK2018\ArmPkg\ArmPkg.dec file 
	...
	# Guids from C' :\UDK2018\ArmPlatformPkg\ArmPlatformPkg.dec file 
	'gArmPlatformTokenSpaceGuid' : [ 0x9c0aaed4, 0x74c5, 0x4043, 0xb4, 0x17, 0xa3, 0x22, 0x38, 0x14, 0xce, 0x76 ],
	# Guids from C' :\UDK2018\ArmVirtPkg\ArmVirtPkg.dec file 
	...
	# Guids from C' :\UDK2018\BeagleBoardPkg\BeagleBoardPkg.dec file 
	'gBeagleBoardTokenSpaceGuid' :  [ 0x6834fe45, 0x4aee, 0x4fc6, 0xbc, 0xb5, 0xff, 0x45, 0xb7, 0xa8, 0x71, 0xe2 ],
	# Guids from C' :\UDK2018\CorebootModulePkg\CorebootModulePkg.dec file 
	...
	# Guids from C' :\UDK2018\CorebootPayloadPkg\CorebootPayloadPkg.dec file 
	...
	# Guids from C' :\UDK2018\CryptoPkg\CryptoPkg.dec file 
	# Guids from C' :\UDK2018\DuetPkg\DuetPkg.dec file 
	...
	# Guids from C' :\UDK2018\EdkCompatibilityPkg\EdkCompatibilityPkg.dec file 
	...
	'gFrameworkBdsFrontPageFormsetGuid' : [ 0x9e0c30bc, 0x3f06, 0x4ba6, 0x82, 0x88, 0x9, 0x17, 0x9b, 0x85, 0x5d, 0xbe ],
	...
	# Guids from C' :\UDK2018\EdkShellBinPkg\EdkShellBinPkg.dec file 
	# Guids from C' :\UDK2018\EmbeddedPkg\EmbeddedPkg.dec file 
	...
	# Guids from C' :\UDK2018\EmulatorPkg\EmulatorPkg.dec file 
	...
	# Guids from C' :\UDK2018\FatBinPkg\FatBinPkg.dec file 
	# Guids from C' :\UDK2018\FatPkg\FatPkg.dec file 
	# Guids from C' :\UDK2018\FmpDevicePkg\FmpDevicePkg.dec file 
	'gFmpDevicePkgTokenSpaceGuid' : [ 0x40b2d964, 0xfe11, 0x40dc, 0x82, 0x83, 0x2e, 0xfb, 0xda, 0x29, 0x53, 0x56 ],
	# Guids from C' :\UDK2018\IntelFrameworkModulePkg\IntelFrameworkModulePkg.dec file 
	...
	# Guids from C' :\UDK2018\IntelFrameworkPkg\IntelFrameworkPkg.dec file 
	...
	# Guids from C' :\UDK2018\IntelFsp2Pkg\IntelFsp2Pkg.dec file 
	...
	'gFspBootLoaderTolumHobGuid' : [ 0x73ff4f56, 0xaa8e, 0x4451, 0xb3, 0x16, 0x36, 0x35, 0x36, 0x67, 0xad, 0x44 ],
	...
	# Guids from C' :\UDK2018\IntelFsp2WrapperPkg\IntelFsp2WrapperPkg.dec file 
	...
	# Guids from C' :\UDK2018\IntelFspPkg\IntelFspPkg.dec file 
	...
	# Guids from C' :\UDK2018\IntelFspWrapperPkg\IntelFspWrapperPkg.dec file 
	...
	'gTopOfTemporaryRamPpiGuid' : [ 0x2f3962b2, 0x57c5, 0x44ec, 0x9e, 0xfc, 0xa6, 0x9f, 0xd3, 0x02, 0x03, 0x2b ],
	# Guids from C' :\UDK2018\IntelSiliconPkg\IntelSiliconPkg.dec file 
	...
	# Guids from C' :\UDK2018\MdeModulePkg\MdeModulePkg.dec file 
	...
	# Guids from C' :\UDK2018\MdePkg\MdePkg.dec file 
	...
	# Guids from C' :\UDK2018\NetworkPkg\NetworkPkg.dec file 
	...
	# Guids from C' :\UDK2018\Nt32Pkg\Nt32Pkg.dec file 
	...
	# Guids from C' :\UDK2018\PcAtChipsetPkg\PcAtChipsetPkg.dec file 
	'gPcAtChipsetPkgTokenSpaceGuid' : [ 0x326ae723, 0xae32, 0x4589, 0x98, 0xb8, 0xca, 0xc2, 0x3c, 0xdc, 0xc1, 0xb1 ],
	# Guids from C' :\UDK2018\QuarkPlatformPkg\QuarkPlatformPkg.dec file 
	...
	# Guids from C' :\UDK2018\QuarkSocPkg\QuarkSocPkg.dec file 
	...
	# Guids from C' :\UDK2018\SecurityPkg\SecurityPkg.dec file 
	...
	# Guids from C' :\UDK2018\ShellBinPkg\ShellBinPkg.dec file 
	# Guids from C' :\UDK2018\ShellPkg\ShellPkg.dec file 
	...
	# Guids from C' :\UDK2018\SignedCapsulePkg\SignedCapsulePkg.dec file 
	...
	# Guids from C' :\UDK2018\SourceLevelDebugPkg\SourceLevelDebugPkg.dec file 
	...
	# Guids from C' :\UDK2018\StandaloneMmPkg\StandaloneMmPkg.dec file 
	...
	# Guids from C' :\UDK2018\StdLib\StdLib.dec file 
	...
	# Guids from C' :\UDK2018\StdLibPrivateInternalFiles\DoNotUse.dec file 
	# Guids from C' :\UDK2018\UefiCpuPkg\UefiCpuPkg.dec file 
	...
	# Guids from C' :\UDK2018\UefiTestingPkg\UefiTestingPkg.dec file 
	'gUefiTestingPkgTokenSpaceGuid' : [ 0xb3f4fb27, 0xf382, 0x4484, 0x9b, 0x77, 0x22, 0x6b, 0x2b, 0x43, 0x48, 0xbb ],
	# Guids from C' :\UDK2018\Vlv2DeviceRefCodePkg\Vlv2DeviceRefCodePkg.dec file 
	...
	# Guids from C' :\UDK2018\Vlv2TbltDevicePkg\PlatformPkg.dec file 
