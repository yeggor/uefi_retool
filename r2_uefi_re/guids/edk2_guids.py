...
edk2_guids = {
	# Guids from C' :\edk2\ArmPkg\ArmPkg.dec file 
	...
	# Guids from C' :\edk2\ArmPlatformPkg\ArmPlatformPkg.dec file 
	'gArmPlatformTokenSpaceGuid' : [ 0x9c0aaed4, 0x74c5, 0x4043, 0xb4, 0x17, 0xa3, 0x22, 0x38, 0x14, 0xce, 0x76 ],
	# Guids from C' :\edk2\ArmVirtPkg\ArmVirtPkg.dec file 
	...
	# Guids from C' :\edk2\CryptoPkg\CryptoPkg.dec file 
	# Guids from C' :\edk2\DynamicTablesPkg\DynamicTablesPkg.dec file 
	...
	# Guids from C' :\edk2\EmbeddedPkg\EmbeddedPkg.dec file 
	...
	# Guids from C' :\edk2\EmulatorPkg\EmulatorPkg.dec file 
	...
	# Guids from C' :\edk2\FatPkg\FatPkg.dec file 
	# Guids from C' :\edk2\FmpDevicePkg\FmpDevicePkg.dec file 
	...
	# Guids from C' :\edk2\IntelFsp2Pkg\IntelFsp2Pkg.dec file 
	...
	# Guids from C' :\edk2\IntelFsp2WrapperPkg\IntelFsp2WrapperPkg.dec file 
	...
	# Guids from C' :\edk2\MdeModulePkg\MdeModulePkg.dec file 
	...
	# Guids from C' :\edk2\MdePkg\MdePkg.dec file 
	...
	# Guids from C' :\edk2\NetworkPkg\NetworkPkg.dec file 
	...
	# Guids from C' :\edk2\OvmfPkg\OvmfPkg.dec file 
	...
	# Guids from C' :\edk2\PcAtChipsetPkg\PcAtChipsetPkg.dec file 
	'gPcAtChipsetPkgTokenSpaceGuid' : [ 0x326ae723, 0xae32, 0x4589, 0x98, 0xb8, 0xca, 0xc2, 0x3c, 0xdc, 0xc1, 0xb1 ],
	# Guids from C' :\edk2\SecurityPkg\SecurityPkg.dec file 
	...
	# Guids from C' :\edk2\ShellPkg\ShellPkg.dec file 
	...
	# Guids from C' :\edk2\SignedCapsulePkg\SignedCapsulePkg.dec file 
	...
	# Guids from C' :\edk2\SourceLevelDebugPkg\SourceLevelDebugPkg.dec file 
	...
	# Guids from C' :\edk2\StandaloneMmPkg\StandaloneMmPkg.dec file 
	...
	# Guids from C' :\edk2\UefiCpuPkg\UefiCpuPkg.dec file 
	...
	# Guids from C' :\edk2\UefiPayloadPkg\UefiPayloadPkg.dec file 
